                ...
                <>
                    ...
                    <div className="relative flex w-full items-center justify-center">
                        ...
                        <span className="relative bg-card px-2 py-1">
                            Tambien puedes ingresar esta clave de configuración manualmente:
                        </span>
                    </div>
...
export default function TwoFactorSetupModal({
    ...
    const modalConfig = useMemo<{
        ...
        return {
            title: 'Habilitar autenticación de doble factor',
            description:
                'Para habilitar la autenticación de dos factores, escanea el código QR o ingresa la clave de configuración en tu aplicación de autenticación.',
            buttonText: 'Continuar',
        };
